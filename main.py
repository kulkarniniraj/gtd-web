...
def get_tasks(view: str = "inbox"): # Renamed function, added view parameter
    ...
    return Group(
        render_sidebar(current_view=view, inbox_count=inbox_count, today_count=today_count, active_count=active_count, maybe_count=maybe_count),
        H1(header_title, id="main-content-header", _class="text-2xl font-bold", 
           hx_swap_oob="true"),
        Div(*task_items, id="inbox-task-list-inner")
    )

def render_sidebar(current_view: str, inbox_count: int = 0, today_count: int = 0, active_count: int = 0, maybe_count: int = 0):
            ...
            Div(
                ...
                Div(
                    ...
                    A(
                        ...
                        Span(str(inbox_count), cls="text-sm font-semibold") if inbox_count > 0 else None,
                    ...
                    A(
                        ...
                        Span(str(today_count), cls="text-sm text-gray-500") if today_count > 0 else None,
                    ...
                    A(
                        ...
                        Span(str(active_count), cls="text-sm text-gray-500") if active_count > 0 else None,
                    ...
                    A(
                        ...
                        Span(str(maybe_count), cls="text-sm text-gray-500") if maybe_count > 0 else None,
